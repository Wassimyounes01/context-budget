'use strict';
/**
 * context-budget.cjs — context pressure meter + token budget for long-running LLM agents.
 *
 ...
 * thresholds and a weight. Context Budget blends them into one 0–1 pressure score, maps it to a load
 ...
 *
 *   const { Meter, Budget, estimateTokens } = require('./context-budget.cjs');
 */
